...
send(msg.chat_id_, msg.id_,'❀⇠  عدد الكروبات الان » { '..#group..' }'..STIVNk..''..STIVN..'\n❀⇠  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع نادي معرفات الكروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' ❀⇠ تعال حبي يناديونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
