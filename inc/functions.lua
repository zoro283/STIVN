...
if redis:get(stivn..'group:add'..msg.chat_id_) then  return '⚘ 𖡗 المجموعة تم تفعيلها مُسبقاً . ' end
...
if not redis:get(stivn..'group:add'..msg.chat_id_) then return '𖡗  المجموعه تم تعطيلها مُسبقاً .' end  
...
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك حظر قلب استيفن\n") 
elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك طرد قلب استيفن\n") 
elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك تقييد قلب استيفن\n") 
elseif UserID == 1506447245 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك تقييد مطور السورس\n") 
elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك تقييد المطور\n") 
...
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك كتم مطور السورس\n")
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك كتم قلب استيفن\n") 
elseif UserID == 1506447245 then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚘ 𖡗 لا يمكنك كتم المطور\n") 
...
if cmd == "dn_sudo" then
if not redis:sismember(stivn..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⚘ 𖡗 العضو » '..USERNAME..' \n⚘ 𖡗  الايدي » (`'..UserID..'`)\n⚘ 𖡗 انه بالتأكيد ليس مطور \n') end
redis:srem(stivn..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⚘ العضو » ❪ '..USERNAME..' ❫\n⚘ الايدي » ❪ '..UserID..' ❫\n⚘ تم تنزيله من المطور \n',17,USERCAR) 
end
