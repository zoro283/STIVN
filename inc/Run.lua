...
▀█████████▄           ██       ████████
██▀ │stivn ﹏ @IE_S9
│تم تطوير وبرمجة السورس من قبل فارسᐂ .
│@IE_S9
#-------------------------------------------------------------------
]]
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/zoro283/stivn/master/plugins/games.lua','./plugins/games.lua')
