...
▀▀███▀▀▀██▄           ██               ██               █████████
  ...
  ███    ███ ███          ██               ██             ██                   ██
▄█████████▀           ██               ██             ██                    ██▄████████▀ │STIVN ﹏ @IE_S9
│تم تطوير وبرمجة السورس من قبل فارس│@IE_S9
#-------------------------------------------------------------------
]]
...
if msg.sender_user_id_ == 1152127659 then 
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/AhmedElsayed111/Stivn/master/plugins/games.lua','./plugins/games.lua')
