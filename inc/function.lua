...
─────▀██▀─────
│@El_Hagag ‿ @ElBOB_x
تم تطوير السورس بواسطه مطور سورس استيفن💞
│@IE_S9 ‿ @IE_S9
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(stivn..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 1267082964 then
var =  'مطور السورس'
elseif  UserID == 1590091397 then
var =  'مطور السورس'
elseif  UserID == 1100569774 then
var =   مطور السورس
elseif  UserID == 1444059892 then
var =   مطور السورس 
elseif  UserID == 1059262308 then
var =  'ملك التلجرام👑'
elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(stivn..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(stivn..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(stivn..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(stivn..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(stivn..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(stivn..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(stivn..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(stivn..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(stivn..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(stivn..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(stivn..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(stivn..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(stivn..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(stivn..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(stivn..':SUDO_BOT:')
message = '☆↯ ** قائمه الـمـطـوريـن : \n\n`☆↯ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(stivn..'username:'..v)
local count = redis:scard(stivn..'mtwr_count'..v)
...
local monsha = redis:smembers(stivn..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n☆↯ قائمه المدراء :*\n\n'
local list = redis:smembers(stivn..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(stivn..'admins:'..msg.chat_id_)
...
local list = redis:smembers(stivn..'whitelist:'..msg.chat_id_)
...
if redis:sismember(stivn..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(stivn..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(stivn..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(stivn..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(stivn..'gban_users')
...
local list = redis:smembers(stivn..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(stivn..':Filter_Word:'..msg.chat_id_,word) then 
return  "☆↯ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(stivn..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(stivn..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(stivn..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(stivn..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(stivn..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(stivn..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(stivn..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(stivn..'group:ids')
message = '☆↯ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(stivn..'group:name'..v)
if info then 
...
redis:del(
stivn..'group:add'..id_group,
stivn..'lock_link'..id_group, 
stivn..'lock_id'..id_group,
stivn..'lock_spam'..id_group, 
stivn..'lock_webpage'..id_group,
stivn..'lock_markdown'..id_group,
stivn..'lock_flood'..id_group,
stivn..'lock_bots'..id_group,
stivn..'mute_forward'..id_group,
stivn..'mute_contact'..id_group,
stivn..'mute_location'..id_group,
stivn..'mute_document'..id_group,
stivn..'mute_keyboard'..id_group,
stivn..'mute_game'..id_group,
stivn..'mute_inline'..id_group,
stivn..'lock_username'..id_group,
stivn..'num_msg_stivn'..id_group,
stivn..'replay'..id_group
)
redis:srem(stivn..'group:ids',id_group)
end
...
redis:hset(stivn..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(stivn..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(stivn..'group:add'..msg.chat_id_) then  return '☆↯ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(stivn..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(stivn..':addnumberusers') or 0)
...
local lock_service = redis:get(stivn..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(stivn..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(stivn..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
stivn..'group:add'..msg.chat_id_,true,
stivn..'lock_link'..msg.chat_id_,true, 
stivn..'lock_id'..msg.chat_id_,true,
stivn..'lock_spam'..msg.chat_id_,true,
stivn..'lock_webpage'..msg.chat_id_,true,
stivn..'lock_markdown'..msg.chat_id_,true,
stivn..'lock_flood'..msg.chat_id_,true,
stivn..'lock_bots'..msg.chat_id_,true,
stivn..'mute_forward'..msg.chat_id_,true,
stivn..'mute_contact'..msg.chat_id_,true,
stivn..'mute_location'..msg.chat_id_,true,
stivn..'mute_document'..msg.chat_id_,true,
stivn..'mute_keyboard'..msg.chat_id_,true,
stivn..'mute_game'..msg.chat_id_,true,
stivn..'mute_inline'..msg.chat_id_,true,
stivn..'lock_username'..msg.chat_id_,true,
stivn..'num_msg_stivn'..msg.chat_id_,5, 
stivn..'replay'..msg.chat_id_,true
)

redis:sadd(stivn..'group:ids',msg.chat_id_) 
redis:sadd(stivn..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(stivn..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(stivn..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(stivn..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(stivn..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID,'username',Resolv)
redis:sadd(stivn..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(stivn..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(stivn..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(stivn..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID,'username',Resolv)
redis:sadd(stivn..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(stivn..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(stivn..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(stivn..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(stivn..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(stivn..'whitelist:'..ChatID,UserID)
...
if redis:sismember(stivn..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..'owners:'..ChatID,UserID)
...
if redis:sismember(stivn..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(stivn..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(stivn..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(stivn..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(stivn..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(stivn..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1100569774 then  return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك حظر مطور السورس\n")  
elseif UserID == 1444059892 then  return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك حظر مطور السورس\n")elseif redis:sismember(stivn..':SUDO_BOT:',UserID) then 
...
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(stivn..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(stivn..'banned:'..ChatID,UserID)
...
if redis:sismember(stivn..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(stivn..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(stivn..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(stivn..'username:'..UserID, 'username',Resolv)
redis:sadd(stivn..'gban_users',UserID)
...
redis:srem(stivn..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(stivn..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(stivn..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(stivn..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(stivn..'username:'..UserID, 'username', UserName)
redis:sadd(stivn..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(stivn..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'☆↯ **العضو » ❪ '..UserName..' ❫\n☆↯ **الايدي » ❪ `'..UserID..'` ❫\n☆↯ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(stivn..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(stivn..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"☆↯ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(stivn..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(stivn..'username:'..UserID, 'username', Resolv)
redis:sadd(stivn..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(stivn..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(stivn..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'☆↯ **العضو » '..USERNAME..' \n☆↯ ** الايدي » (`'..UserID..'`)\n☆↯ **انه بالتأكيد ليس مطور \n') end
redis:srem(stivn..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'☆↯ العضو » ❪ '..USERNAME..' ❫\n☆↯ الايدي » ❪ '..UserID..' ❫\n☆↯ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(stivn..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(stivn..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(stivn..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(stivn..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*☆↯*` اعدادات المجموعه :` \n"
.."\n☆↯ التعديل «» "..(redis:get(stivn..'lock_edit'..msg.chat_id_) or 'false')
.."\n☆↯ الروابط «» "..(redis:get(stivn..'lock_link'..msg.chat_id_) or 'false')
.."\n☆↯ التاك «» "..(redis:get(stivn..'lock_tag'..msg.chat_id_) or 'false')
.."\n☆↯ المعرفات «» "..(redis:get(stivn..'lock_username'..msg.chat_id_) or 'false')
.."\n☆↯ التكرار «» "..(redis:get(stivn..'lock_flood'..msg.chat_id_) or 'false')
.."\n☆↯ الكلايش «» "..(redis:get(stivn..'lock_spam'..msg.chat_id_) or 'false')
.."\n☆↯ الويب «» "..(redis:get(stivn..'lock_webpage'..msg.chat_id_) or 'false')
.."\n☆↯ الماركدوان «» "..(redis:get(stivn..'lock_markdown'..msg.chat_id_) or 'false')
.."\n☆↯ بالطرد البوتات «» "..(redis:get(stivn..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n☆↯ البوتات «» "..(redis:get(stivn..'lock_bots'..msg.chat_id_) or 'false')
.."\n☆↯ عدد التكرار «» "..(redis:get(stivn..'num_msg_stivn'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n☆↯`اعدادات الوسائط :`\n"
.."\n*☆↯ *المتحركه «» "..(redis:get(stivn..'mute_gif'..msg.chat_id_) or 'false')
.."\n☆↯ الدردشه «» "..(redis:get(stivn..'mute_text'..msg.chat_id_) or 'false')
.."\n☆↯ الانلاين «» "..(redis:get(stivn..'mute_inline'..msg.chat_id_) or 'false')
.."\n☆↯ الالعاب «» "..(redis:get(stivn..'mute_game'..msg.chat_id_) or 'false')
.."\n☆↯ الصور «» "..(redis:get(stivn..'mute_photo'..msg.chat_id_) or 'false')
.."\n☆↯ الفيديو «» "..(redis:get(stivn..'mute_video'..msg.chat_id_) or 'false')
.."\n☆↯ البصمات «» "..(redis:get(stivn..'mute_audio'..msg.chat_id_) or 'false')
.."\n☆↯ الصوت «» "..(redis:get(stivn..'mute_voice'..msg.chat_id_) or 'false')
.."\n☆↯ الملصقات «» "..(redis:get(stivn..'mute_sticker'..msg.chat_id_) or 'false')
.."\n☆↯ الجهات «» "..(redis:get(stivn..'mute_contact'..msg.chat_id_) or 'false')
.."\n☆↯ التوجيه «» "..(redis:get(stivn..'mute_forward'..msg.chat_id_) or 'false')
.."\n☆↯ الموقع «» "..(redis:get(stivn..'mute_location'..msg.chat_id_) or 'false')
.."\n☆↯ الملفات «» "..(redis:get(stivn..'mute_document'..msg.chat_id_) or 'false')
.."\n☆↯ الاشعارات «» "..(redis:get(stivn..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n☆↯ الكيبورد «» "..(redis:get(stivn..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*☆↯*`اعدادات اخرى : `"
.."\n\n*☆↯*الترحيب «» "..welcomex
.."\n*☆↯*الردود «» "..replayx
...
.."\n*☆↯*الويب «» "..(redis:get(stivn..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*☆↯*الماركدوان «» "..(redis:get(stivn..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*☆↯*البوتات بالطرد «» "..(redis:get(stivn..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*☆↯*البوتات «» "..(redis:get(stivn..'lock_bots'..msg.chat_id_) or 'false')
.."\n*☆↯*عدد التكرار «» "..(redis:get(stivn..'num_msg_stivn'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*☆↯*اعدادات التقـييد :\n"
.."\n*☆↯*التقييد بالتوجيه «» "..(redis:get(stivn..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*☆↯*التقييد بالصور «» "..(redis:get(stivn..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*☆↯*التقييد بالروابط «» "..(redis:get(stivn..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*☆↯*التقييد بالمتحركه «» "..(redis:get(stivn..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*☆↯*التقييد الفيديو «» "..(redis:get(stivn..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
...
.."\n*☆↯*التوجيه «» "..(redis:get(stivn..'mute_forward'..msg.chat_id_) or 'false')
.."\n*☆↯*الموقع «» "..(redis:get(stivn..'mute_location'..msg.chat_id_) or 'false')
.."\n*☆↯*الملفات «» "..(redis:get(stivn..'mute_docum